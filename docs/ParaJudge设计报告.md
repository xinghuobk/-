...
## 二、核心学术论文与分析 — 从"单个 LLM"到"多智能体法庭"的完整演进史

> **阅读指南**：本节从零开始讲解——如果你完全不了解 LLM 或多智能体辩论，从 2.1 开始按顺序读；如果你已有背景，可直接跳到 2.3 看关键论文分析。每个关键概念均提供**生活比喻**、**具体示例**和**与 ParaJudge 设计的对应关系**。
