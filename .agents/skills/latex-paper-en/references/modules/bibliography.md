...
See also: [verification.md](../citations/verification.md) for API-based verification.
See also: [styles.md](../citations/styles.md) for IEEE/APA/Vancouver/Nature format rules.
See also: [journal-abbreviations.md](../citations/journal-abbreviations.md) for ISO 4 journal name abbreviations.
