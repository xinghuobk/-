...
2. **Accept target format** from user:
   ...
   - If no guide provided, use known venue rules from catalog.md
...
- Cross-reference styles.md for exact rules
...
- Cross-reference number-unit-guide.md
- SI unit formatting
...
- **User-provided guide overrides all defaults**: if the user supplies a journal's author guidelines, those rules take absolute priority over catalog.md
